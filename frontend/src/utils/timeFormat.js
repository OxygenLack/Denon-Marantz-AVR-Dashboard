...
export function resolveTimeFormat(configValue, timezone) {
...
export function formatTimeInput(value, format = '24h') {
  return formatTimeLabel(value, format)
}

export function parseTimeInput(input, fallback = '00:00') {
